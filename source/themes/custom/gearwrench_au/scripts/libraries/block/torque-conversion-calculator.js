(function ($, Drupal) {
  ...
  Drupal.behaviors.torqueConversionCalculator = {
    attach: function (context, settings) {
      $('#block--torque-conversion-calculator__button-convert').once('torque-conversion-calculator').on('click', function () {
      ...
      $('#block--torque-conversion-calculator__button-reset').on('click', function () {
