(function ($, Drupal, once) {
  ...
  Drupal.behaviors.productCategoryFilters = {
    ...
    attach: function (context, settings) {
      ...
      $(once('product-category-filters', '.sata-product-category-filters:not(.sata-product-category-filters--js-initialized)', context)).each(function (index) {
  ...
  Drupal.behaviors.productCategoryFilterTabs = {
    attach: function (context, settings) {
      $(once('product-category-filter-tabs', '.sata-product-category-filters', context)).each(function (index) {
