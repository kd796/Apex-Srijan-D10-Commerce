 ...
 * Index:
 *
 * @see crescenttool_au_preprocess_block()
 * @see crescenttool_au_preprocess_block__page_title_block()
 */
 ...
 */
function crescenttool_au_preprocess_block(array &$variables) {
  /*
   * Pass id into menu attributes for better hook-suggestions.
   * @see crescenttool_au_theme_suggestions_menu_alter();
   */
 ...
 */
function crescenttool_au_preprocess_block__page_title_block(&$variables) {
  ...
  if ($node instanceof NodeInterface) {
    ...
    if ($node->hasField('field_component_hero')
        && !$node->get('field_component_hero')->isEmpty()) {
      ...
      $variables['crescenttool_au_breadcrumbs'] = \Drupal::service('renderer')->render($render);
    }
  }
}
