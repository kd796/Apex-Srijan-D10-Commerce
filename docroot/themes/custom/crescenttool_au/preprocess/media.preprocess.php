 ...
 *
 * Index:
 * @see crescenttool_au_preprocess_media()
 * @see crescenttool_au_preprocess_media__remote_video__hero()
 */
 ...
 */
function crescenttool_au_preprocess_media(array &$variables) {
 ...
 */
function crescenttool_au_preprocess_media__remote_video(array &$variables) {
  /** @var \Drupal\media\MediaInterface $media */
  $media = $variables['media'];
