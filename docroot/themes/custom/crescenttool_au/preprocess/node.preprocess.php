 ...
 * Index:
 *
 * @see crescenttool_au_preprocess_node()
 * @see crescenttool_au_preprocess_node__full()
 * @see crescenttool_au_preprocess_node__tile()
 ...
 * @see crescenttool_au_preprocess_node__product__full()
 * @see crescenttool_au_preprocess_node__search_index()
 * @see crescenttool_au_preprocess_node__product__search_index()
 * @see crescenttool_au_preprocess_node__product_category__full()
 * @see crescenttool_au_preprocess_node__product_category__tile()
 * @see crescenttool_au_preprocess_node__social_post__teaser()
 * @see crescenttool_au_preprocess_node__product_industry__full()
 */
 ...
 */
function crescenttool_au_preprocess_node(array &$variables) {
  // dump($variables);
  /*
 ...
 */
function crescenttool_au_preprocess_node__full(array &$variables) {
  // Nothing to see here.;.
}
 ...
 */
function crescenttool_au_preprocess_node__landing_page__full(array &$variables) {
  // Nothing to see here.
}
 ...
 * Implements hook_preprocess_node__BUNDLE__VIEW_MODE() for page, full.
 */
function crescenttool_au_preprocess_node__page__full(array &$variables) {
  // Nothing to see here.
}
 ...
 */
function crescenttool_au_preprocess_node__search_result(array &$variables) {
 ...
 */
function crescenttool_au_preprocess_node__product__teaser(&$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
 ...
 */
function crescenttool_au_preprocess_node__product__set_listing(&$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
 ...
 */
function crescenttool_au_preprocess_node__product__full(array &$variables) {
  /** @var Drupal\node\NodeInterface $node */
 ...
 */
function crescenttool_au_preprocess_node__search_index(&$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
 ...
 */
function crescenttool_au_preprocess_node__product__search_index(&$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
 ...
 */
function crescenttool_au_preprocess_node__product_category__full(array &$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
 ...
 * Implements hook_preprocess_node__BUNDLE__VIEW_MODE() for product_category, full.
 */
function crescenttool_au_preprocess_node__product_industry__full(array &$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
 ...
 * Implements hook_preprocess_node__BUNDLE__VIEW_MODE() for product_category, full.
 */
function crescenttool_au_preprocess_node__product_trade__full(array &$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
 ...
 */
function crescenttool_au_preprocess_node__tile(&$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
 ...
 */
function crescenttool_au_preprocess_node__social_post__teaser(&$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
 ...
 * Implements hook_preprocess_node__BUNDLE__VIEW_MODE() for media page full.
 */
function crescenttool_au_preprocess_node__media_page__full(&$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
