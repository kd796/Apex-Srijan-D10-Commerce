 ...
 * Index:
 *
 * @see crescenttool_au_preprocess_paragraph()
 * @see crescenttool_au_preprocess_paragraph__accordion__full()
 * @see crescenttool_au_preprocess_paragraph__accordion_item__full()
 ...
 * @see crescenttool_au_preprocess_paragraph__featured_media__full()
 * @see crescenttool_au_preprocess_paragraph__pullquote__full()
 * @see crescenttool_au_preprocess_paragraph__section__full()
 * @see crescenttool_au_preprocess_paragraph__tabs__full()
 * @see crescenttool_au_preprocess_paragraph__tabs_tab__full()
 * @see crescenttool_au_preprocess_paragraph__product_slider__full()
 * @see crescenttool_au_preprocess_paragraph__banner_cta_slider__full()
 */
 ...
 */
function crescenttool_au_preprocess_paragraph(array &$variables) {
 ...
 */
function crescenttool_au_preprocess_paragraph__accordion__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function crescenttool_au_preprocess_paragraph__accordion_item__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function crescenttool_au_preprocess_paragraph__content__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
 ...
 */
function crescenttool_au_preprocess_paragraph__steps__full(array &$variables) {
  // Nothing to see here.
}
 ...
 */
function crescenttool_au_preprocess_paragraph__step__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function crescenttool_au_preprocess_paragraph__embed_iframe__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function crescenttool_au_preprocess_paragraph__featured_content__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function crescenttool_au_preprocess_paragraph__featured_links__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function crescenttool_au_preprocess_paragraph__featured_media__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function crescenttool_au_preprocess_paragraph__hero__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function crescenttool_au_preprocess_paragraph__hero_slide__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
  ...
  if (!empty($paragraph->get('field_title_image')->getValue())) {
 ...
 */
function crescenttool_au_preprocess_paragraph__pullquote__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function crescenttool_au_preprocess_paragraph__section__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $paragraphId = $paragraph->id();
  ...
  if ($paragraph->hasField('field_background_color')
      && isset($paragraph->get('field_background_color')->getValue()[0])) {
 ...
 */
function crescenttool_au_preprocess_paragraph__tabs__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function crescenttool_au_preprocess_paragraph__tabs_tab__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function crescenttool_au_preprocess_paragraph__product_slider__full(&$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function crescenttool_au_preprocess_paragraph__banner_cta_slider__full(&$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 * Implements hook_preprocess_paragraph__BUNDLE__VIEW_MODE() for hero_slide, full.
 */
function crescenttool_au_preprocess_paragraph__banner_cta_slide__thumbnail(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
