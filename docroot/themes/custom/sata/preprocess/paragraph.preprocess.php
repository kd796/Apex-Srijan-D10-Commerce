 ...
 * Index:
 *
 * @see sata_preprocess_paragraph()
 * @see sata_preprocess_paragraph__accordion__full()
 * @see sata_preprocess_paragraph__accordion_item__full()
 * @see sata_preprocess_paragraph__content__full()
 * @see sata_preprocess_paragraph__hero__full()
 ...
 * @see sata_preprocess_paragraph__embed_iframe__full()
 * @see sata_preprocess_paragraph__featured_media__full()
 * @see sata_preprocess_paragraph__section__full()
 * @see sata_preprocess_paragraph__product_slider__full()
 * @see sata_preprocess_paragraph__tabs__full()
 * @see sata_preprocess_paragraph__tabs_tab__full()
 */
 ...
 */
function sata_preprocess_paragraph(array &$variables) {
 ...
 */
function sata_preprocess_paragraph__accordion__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function sata_preprocess_paragraph__accordion_item__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function sata_preprocess_paragraph__content_callout_container__full(array &$variables) {
 ...
 */
function sata_preprocess_paragraph__content_callout__full(array &$variables) {
 ...
 * Implements hook_preprocess_paragraph__BUNDLE__VIEW_MODE() for content_callout, full.
 */
function sata_preprocess_paragraph__digital_resources__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
 ...
 */
function sata_preprocess_paragraph__steps__full(array &$variables) {
  // Nothing to see here.
}
 ...
 */
function sata_preprocess_paragraph__step__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function sata_preprocess_paragraph__embed_iframe__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function sata_preprocess_paragraph__featured_content__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function sata_preprocess_paragraph__featured_links__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function sata_preprocess_paragraph__featured_media__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function sata_preprocess_paragraph__hero__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function sata_preprocess_paragraph__hero_slide__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function sata_preprocess_paragraph__pullquote__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function sata_preprocess_paragraph__section__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $paragraphId = $paragraph->id();
  $base_class = $variables['component_base_class'];
 ...
 */
function sata_preprocess_paragraph__tabs__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function sata_preprocess_paragraph__tabs_tab__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function sata_preprocess_paragraph__product_slider__full(&$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
