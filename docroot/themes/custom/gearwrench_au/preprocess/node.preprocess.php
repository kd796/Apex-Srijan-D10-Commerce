 ...
 */
function gearwrench_au_preprocess_node(array &$variables) {
  /*
 ...
 */
function gearwrench_au_preprocess_node__full(array &$variables) {
  // Nothing to see here.;.
}
 ...
 */
function gearwrench_au_preprocess_node__landing_page__full(array &$variables) {
  // Nothing to see here.
}
 ...
 * Implements hook_preprocess_node__BUNDLE__VIEW_MODE() for page, full.
 */
function gearwrench_au_preprocess_node__page__full(array &$variables) {
  // Nothing to see here.
 ...
 */
function gearwrench_au_preprocess_node__media_page__full(&$variables) {
 ...
 */
function gearwrench_au_preprocess_node__media_page__teaser(&$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
 ...
 */
function gearwrench_au_preprocess_node__product__set_listing(&$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
 ...
 */
function gearwrench_au_preprocess_node__product__full(array &$variables) {
  /** @var Drupal\node\NodeInterface $node */
  ...
  $geo = $_SERVER['HTTP_X_GEO_COUNTRY'];
  if (!empty($geo) && ($geo == "AU" || $geo == "IN")) {
 ...
 */
function gearwrench_au_preprocess_node__search_result(array &$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
 ...
 */
function gearwrench_au_preprocess_node__product__teaser(&$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
 ...
 */
function gearwrench_au_preprocess_node__search_index(&$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
 ...
 */
function gearwrench_au_preprocess_node__product__search_index(&$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
 ...
 */
function gearwrench_au_preprocess_node__product_category__full(array &$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
 ...
 * Implements hook_preprocess_node__BUNDLE__VIEW_MODE() for product_category, full.
 */
function gearwrench_au_preprocess_node__product_industry__full(array &$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
 ...
 */
function gearwrench_au_preprocess_node__tile(&$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
 ...
 */
function gearwrench_au_preprocess_node__social_post__teaser(&$variables) {
  /** @var \Drupal\node\NodeInterface $node */
  $node = $variables['node'];
  $bundle = $node->bundle();
  $view_mode = $variables['view_mode'];
