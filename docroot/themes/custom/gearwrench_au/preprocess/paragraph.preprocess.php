 ...
 * Index:
 *
 * @see gearwrench_au_preprocess_paragraph()
 * @see gearwrench_au_preprocess_paragraph__accordion__full()
 * @see gearwrench_au_preprocess_paragraph__accordion_item__full()
 * @see gearwrench_au_preprocess_paragraph__content__full()
 * @see gearwrench_au_preprocess_paragraph__hero__full()
 * @see gearwrench_au_preprocess_paragraph__hero_slide__full()
 * @see gearwrench_au_preprocess_paragraph__content_callout_container__full()
 * @see gearwrench_au_preprocess_paragraph__content_callout__full()
 * @see gearwrench_au_preprocess_paragraph__digital_resources__full()
 * @see gearwrench_au_preprocess_paragraph__steps__full()
 * @see gearwrench_au_preprocess_paragraph__step__full()
 * @see gearwrench_au_preprocess_paragraph__embed_iframe__full()
 * @see gearwrench_au_preprocess_paragraph__featured_media__full()
 * @see gearwrench_au_preprocess_paragraph__section__full()
 * @see gearwrench_au_preprocess_paragraph__product_slider__full()
 * @see gearwrench_au_preprocess_paragraph__tabs__full()
 * @see gearwrench_au_preprocess_paragraph__tabs_tab__full()
 */
 ...
 */
function gearwrench_au_preprocess_paragraph(array &$variables) {
 ...
 */
function gearwrench_au_preprocess_paragraph__accordion__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function gearwrench_au_preprocess_paragraph__accordion_item__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function gearwrench_au_preprocess_paragraph__content__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
 ...
 */
function gearwrench_au_preprocess_paragraph__content_callout_container__full(array &$variables) {
 ...
 */
function gearwrench_au_preprocess_paragraph__content_callout__full(array &$variables) {
 ...
 */
function gearwrench_au_preprocess_paragraph__step__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function gearwrench_au_preprocess_paragraph__embed_iframe__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function gearwrench_au_preprocess_paragraph__featured_content__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function gearwrench_au_preprocess_paragraph__featured_links__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function gearwrench_au_preprocess_paragraph__featured_media__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function gearwrench_au_preprocess_paragraph__hero__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function gearwrench_au_preprocess_paragraph__hero_slide__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function gearwrench_au_preprocess_paragraph__pullquote__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function gearwrench_au_preprocess_paragraph__section__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $paragraphId = $paragraph->id();
  $base_class = $variables['component_base_class'];
 ...
 */
function gearwrench_au_preprocess_paragraph__tabs__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function gearwrench_au_preprocess_paragraph__tabs_tab__full(array &$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
 ...
 */
function gearwrench_au_preprocess_paragraph__product_slider__full(&$variables) {
  /** @var \Drupal\paragraphs\Entity\Paragraph $paragraph */
  $paragraph = $variables['paragraph'];
  $base_class = $variables['component_base_class'];
