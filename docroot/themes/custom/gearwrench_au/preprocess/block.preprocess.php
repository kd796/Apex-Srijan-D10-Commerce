 ...
 */
function gearwrench_au_preprocess_block(array &$variables) {
  /*
 ...
 */
function gearwrench_au_preprocess_block__page_title_block(&$variables) {
  ...
  if ($node instanceof NodeInterface) {
    ...
    if ($node->hasField('field_component_hero') && !$node->get('field_component_hero')->isEmpty()) {
      ...
      $variables['gearwrench_au_breadcrumbs'] = \Drupal::service('renderer')->render($render);
    }
  }
}
