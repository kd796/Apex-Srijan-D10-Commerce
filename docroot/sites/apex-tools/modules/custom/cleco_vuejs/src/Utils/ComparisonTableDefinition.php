...
class ComparisonTableDefinition {
   ...
   *
   * @var \Doctrine\Common\Collections\Expr\ComparisonTableConfiguration[]
   */
   ...
   *   Data type to apply for the column.
   *
  ...
  public function getColumns() {
    ...
    foreach ($this->getColumnDefinitions() as $definition) {
      ...
      $column['label'] = $units ?? $definition->getLabel();
   ...
   *
   * @param \Doctrine\Common\Collections\Expr\ComparisonTableConfiguration|string $configuration
   */
   ...
   *
   * @param \Doctrine\Common\Collections\Expr\ComparisonTableConfiguration[] $array
   */
   ...
   *   Parent array.
   * @param string $key
   *   Key or array path in dot notation.
   * @param null $default
   *   Default value if the provided key is not found in an item.
   *
   * @return array
   */
