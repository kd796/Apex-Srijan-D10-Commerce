...
use Drupal\step\Traits\RecordTrait;
...
class ElasticSearchService
{
     ...
     * @param array $indices
     */
    public function getSingleProduct(array $matchQuery, array $indices = [], bool $assetsOnly = false)
    {
        $params = [
     ...
     * @param array $indices
     */
    public function getMultipleProducts(array $matchQuery, array $indices = [])
    {
        $params = [
            'index' => $indices ?: StepHelper::getEsIndexName() . '_products',
            'body'  => [
