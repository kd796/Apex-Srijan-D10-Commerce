...
namespace Drupal\ecom_product_category_filtering\Plugin\Block;
...
class ProductCategoryFilters extends BlockBase {
  ...
  public function build() {
    return [
      'product_category_filters_form' => $this->formBuilder->getForm('Drupal\ecom_product_category_filtering\Form\ProductCategoryFiltersForm'),
    ];
  }
