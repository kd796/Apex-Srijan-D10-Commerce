 ...
 *
 * @FieldWidget(
 *   id = "float_label_textarea",
 *   label = @Translation("Float Label (Textarea)"),
 *   field_types = {
 *     "string_long",
 *     "text_long",
 *   }
 * )
 */
class FloatLabelTextarea extends TextareaWidget implements WidgetInterface {
