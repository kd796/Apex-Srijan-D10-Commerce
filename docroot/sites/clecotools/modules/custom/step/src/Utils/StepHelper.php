...
use Drupal;
use Drupal\step\Utils\Configurations\AccessoriesConfiguration;
use Drupal\step\Utils\Configurations\AdvancedDrillsConfiguration;
use Drupal\step\Utils\Configurations\AirMotorsConfiguration;
use Drupal\step\Utils\Configurations\ControllersAndSoftwareConfiguration;
use Drupal\step\Utils\Configurations\ElectricTorqueWrenchesConfiguration;
use Drupal\step\Utils\Configurations\FixturedSpindlesConfiguration;
use Drupal\step\Utils\Configurations\GrindersConfiguration;
use Drupal\step\Utils\Configurations\HandDrillingCountersinkingAndSpotfacingConfiguration;
use Drupal\step\Utils\Configurations\ImpactWrenchesConfiguration;
use Drupal\step\Utils\Configurations\LintPickerConfiguration;
use Drupal\step\Utils\Configurations\NibblersConfiguration;
use Drupal\step\Utils\Configurations\NutrunnersAndScrewdriversConfiguration;
use Drupal\step\Utils\Configurations\PercussionConfiguration;
use Drupal\step\Utils\Configurations\PulseToolsConfiguration;
use Drupal\step\Utils\Configurations\RivetingConfiguration;
use Drupal\step\Utils\Configurations\RoutersConfiguration;
use Drupal\step\Utils\Configurations\SandersAndPolishersConfiguration;
use Drupal\step\Utils\Configurations\SawsConfiguration;
use Drupal\step\Utils\Configurations\ShearsAndScissorsConfiguration;
use Drupal\step\Utils\Configurations\SpecialtyToolsConfiguration;
