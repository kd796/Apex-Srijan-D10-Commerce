...
namespace Drupal\crescenttool_product_category_filtering\Form;
...
/**
 * Provides a CT Product Category Filtering form.
 */
class ProductCategoryFiltersForm extends FormBase {
  ...
  public function getFormId() {
    return 'crescenttool_product_category_filters';
  }
