...
use Drupal\apex_common\RemoveNonSpecifiedProducts;
 ...
 */
class RemoveNonSpecifiedProductsForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['csv']['csv_file'] = [
      ...
      '#description' => [
        ...
        '#description' => $this->t('Only upload a CSV file, with the product SKUs.'),
      ],
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    RemoveNonSpecifiedProducts::triggerBatch($this->file);
