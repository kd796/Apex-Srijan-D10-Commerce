...
trait MigrationHelperTrait {
  ...
  public function getAttributeKeyList() {
    $list = [
      ...
      "ATT675268" => "min_length_in",
      "ATT675245" => "min_length_mm",
      ...
      "ATT675271" => "hole_location_in",
      "ATT675248" => "hole_location_mm",
      ...
      "ATT675263" => "axial_tension_compression_nm",
    ];
    return $list;
  }
  ...
  public function getAttributeList() {
    return [
      ...
      "ATT485" => "",
      "ATT666175" => "",
      "ATT666987" => "Female Square",
      "ATT669757" => "",
      "ATT664440" => "",
      "ATT675248" => "Hole Location",
      "ATT675271" => "Hole Location",
      "ATT675245" => "Minimum Length (mm)",
      "ATT140" => "",
      "ATT28570" => "",
      "ATT667215" => "",
      "ATT678997" => "",
