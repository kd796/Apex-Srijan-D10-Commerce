...
use Drupal\at_migrations\Exceptions\PreviouslyImportedException;
use Drupal\at_migrations\FileOperations;
...
class ProductServices extends DrushCommands {
   ...
   *
   * @throws \Drupal\at_migrations\Exceptions\PreviouslyImportedException
   */
