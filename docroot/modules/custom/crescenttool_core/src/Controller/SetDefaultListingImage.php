...
namespace Drupal\crescenttool_core\Controller;
...
class SetDefaultListingImage extends ControllerBase {
  ...
  public function process() {
    ...
    foreach ($chunks as $chunk) {
      $batch['operations'][] = [
        'Drupal\crescenttool_core\Controller\SetDefaultListingImage::setImage',
        [$chunk],
      ];
    }

    batch_set($batch);
    return batch_process('/admin/config/crescenttool-core/set-default-listing-image');
  }
