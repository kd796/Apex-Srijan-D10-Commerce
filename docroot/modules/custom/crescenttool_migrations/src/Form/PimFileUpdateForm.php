...
namespace Drupal\crescenttool_migrations\Form;
...
/**
 * Provides a Crescent PIM dump upload form.
 */
class PimFileUpdateForm extends FormBase {
  ...
  public function getFormId() {
    return 'crescenttool_migrations_pim_upload';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['pim_upload'] = [
      ...
      '#upload_validators' => [
        'crescenttool_migrations_file_validate_is_xml' => [],
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if (!empty($filename)) {
      ...
      $destination = _crescenttool_migrations_clear_destination_and_pull_in_new($filename);
