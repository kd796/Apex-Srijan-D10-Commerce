 ...
 *
 * Performs common file operations we use in multiple places. Including URL calls.
 */
class FileOperations {
  ...
  /**
   * Tells you whether the remote URL gives you a 200 OK or a different response.
   *
   * @param string $url
   *   The URL to test.
   *
